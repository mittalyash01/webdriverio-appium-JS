...
config.capabilities = [
    {
        ...
        platformName: 'iOS',
        platformVersion: process.env.npm_config_osversion || '14.3',
        manufacturer: process.env.npm_config_manufacturer || 'Apple',
        model: process.env.npm_config_model || 'iPhone-11',
